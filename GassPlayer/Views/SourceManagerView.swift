            ...
            VStack(alignment: .leading, spacing: 16) {
                if sourceManager.sources.isEmpty {
                    ...
                    GlassCard {
                        ...
                        // FIX — con il padding di default della GlassCard
                        // (necessario per allineare il chevron come in
                        // HomeView) lo spazio verticale sopra la prima riga e
                        // sotto l'ultima era diventato eccessivo. Compensato
                        // solo sull'asse verticale, senza toccare quello
